...
namespace AdaskoTheBeAsT.Dapper.NodaTime.SqlServer.Test
{
    ...
    public sealed class CalendarSystemTests
    {
        ...
        public CalendarSystemTests(DatabaseFixture databaseFixture)
        {
            ...
            SqlMapper.AddTypeHandler(new CalendarSystemHandler(new SqlServerNodaTimeConfiguration()));
        }
        ...
        {
            // Arrange
            var handler = new CalendarSystemHandler(new SqlServerNodaTimeConfiguration());
