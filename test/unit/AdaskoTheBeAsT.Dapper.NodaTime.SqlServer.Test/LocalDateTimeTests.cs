...
namespace AdaskoTheBeAsT.Dapper.NodaTime.SqlServer.Test
{
    ...
    public sealed class LocalDateTimeTests
    {
        ...
        public LocalDateTimeTests(DatabaseFixture databaseFixture)
        {
            ...
            SqlMapper.AddTypeHandler(new LocalDateTimeHandler(new SqlServerNodaTimeConfiguration()));
        }
        ...
        {
            // Arrange
            var handler = new LocalDateTimeHandler(new SqlServerNodaTimeConfiguration());
