...
namespace AdaskoTheBeAsT.Dapper.NodaTime.SqlServer.Test
{
    ...
    public sealed class DateTimeZoneTests
    {
        ...
        public DateTimeZoneTests(DatabaseFixture databaseFixture)
        {
            ...
            SqlMapper.AddTypeHandler(new DateTimeZoneHandler(DateTimeZoneProviders.Tzdb, new SqlServerNodaTimeConfiguration()));
        }
        ...
        {
            // Arrange
            var handler = new DateTimeZoneHandler(DateTimeZoneProviders.Tzdb, new SqlServerNodaTimeConfiguration());
